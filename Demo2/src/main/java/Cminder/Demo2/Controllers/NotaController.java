...
public class NotaController {
    ...
    public void actualizarAsignaturaParcial(
        ...
        Double valor = cambios.containsKey("valor") ? (Double) cambios.get("valor") : null;
        Double porcentaje = cambios.containsKey("porcentaje") ? (Double) cambios.get("porcentaje") : null;
